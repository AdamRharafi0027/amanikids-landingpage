      ...
      <section className="bg-yellow-50 py-20 px-6">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              كل رسمة أو نشاط رسم يقوم به طفلك يتم حفظه، ويمكنك تصفحه من قسم خاص
              في التطبيق. شاهد تطوره الإبداعي وتفاعل معه بالكلمات الإيجابية ❤️
            </p>
          </motion.div>
      ...
      <section className="bg-rose-50 py-20 px-6">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              يمكنك إرسال رسالة تشجيعية لطفلك تظهر داخل التطبيق مثل: "أحسنت يا
              بطل!" أو "فخور بك لأنك أنهيت حرف أ اليوم!" هذا يعزّز الرابط بين
              الطفل والأهل داخل التجربة التعليمية.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between gap-8">
          ...
          >
            ...
            <p className="text-gray-700 text-lg">
              ابدأ الآن بتجربة تعليمية ممتعة وآمنة لطفلك، وراقب تطوره خطوة
              بخطوة!
            </p>
          </motion.div>
